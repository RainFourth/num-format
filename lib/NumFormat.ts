...
import {Optional, StringBuilder} from "@rrainpath/ts-utils/dist";
...
export class NumFormat implements Formatter<number|bigint, string> {
    ...
    private analyze(){
        let pattern
        const valType = typeof this.originalValue
